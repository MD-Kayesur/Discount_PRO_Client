...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="footer sm:footer-horizontal  bg-red-600   p-10     text-white">
...
<footer className="footer   border-base-300 border-t px-10 py-4 bg-red-600  text-white">
